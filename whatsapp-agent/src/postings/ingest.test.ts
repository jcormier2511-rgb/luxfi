...
// Notifications are now allowlist-gated at send time (config.isPostingChatEnabled), not just
// at ingestion — these tests post into chat "g1", so v4 needs to be enabled for it here too.
